...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tumblelog_post', (
            ...
            ('published_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('data', self.gf('jsonfield.fields.JSONField')(default={}, blank=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lstory.Story'])),
        ))
