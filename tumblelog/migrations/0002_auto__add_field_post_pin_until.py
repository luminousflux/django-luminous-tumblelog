...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.pin_until'
        db.add_column('tumblelog_post', 'pin_until',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.pin_until'
        db.delete_column('tumblelog_post', 'pin_until')
    ...
    models = {
        ...
        'tumblelog.post': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lstory.Story']"}),
            'pin_until': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'post_type': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'published_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'})
        }
    }
