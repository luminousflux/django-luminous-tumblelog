...
var u='http://{{site.domain}}{% url 'tumblelog:bookmarklet.js' %}?api_key={{api_key|escapejs}}';
var fn='{{site.name}}_bookmarklet';
var u1 = 'http://{{site.domain}}{% url 'tumblelog:bookmarklet.html' %}?api_key={{api_key|escapejs}}';
